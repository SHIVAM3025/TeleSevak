...
import app.telesevek.uploadpkg.Helpers.CoreHelper;
import app.telesevek.uploadpkg.Helpers.CustomModel;
import app.telesevek.uploadpkg.Helpers.ImagesAdapter;
...
public class AddPatiantSymtom extends BaseActivity implements SinchService.StartFailedListener {
   ...
   /* RadioGroup radioGroup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_patiant_syemtom);
        ...
        Paa_name = bundle.getString("Pname");
        Paa_num = bundle.getString("Pnum");
        Paa_age = bundle.getString("Page");
        Paa_gender = bundle.getString("Pgender");
        savedImagesUri = new ArrayList<>();


        bt_pickimg = findViewById(R.id.bt_pickimg);
     ...
     /*   mFullName   = findViewById(R.id.ed_pname);*/
       ...
       /* radioGroup = findViewById(R.id.gr);
        ...
        pd = new ProgressDialog(AddPatiantSymtom.this);
        ...
        reference = fStore.collection("Consultation").document(id_consult);
        ...
        */
        ...
        Toast.makeText(AddPatiantSymtom.this, ""+remainconsult, Toast.LENGTH_SHORT).show();
       ...
       /* mPhone.setText(phone);
        ...
        get.addSnapshotListener(AddPatiantSymtom.this, new EventListener<DocumentSnapshot>() {
            @Override
            public void onEvent(@Nullable DocumentSnapshot documentSnapshot, @Nullable FirebaseFirestoreException e) {
                if (documentSnapshot.exists()) {
...
*/
               ...
               /* if(mPhone.length() < 10){
                ...
                DocumentReference documentReference = fStore.collection("Patient").document(Paa_num);
                Map<String,Object> user = new HashMap<>();
                user.put("Name",Paa_name);
                user.put("PhoneNumber","+91"+Paa_num);
                user.put("Symptoms",symtoms);
                user.put("Age",Paa_age);
                user.put("Gender",Paa_gender);
               ...
               /* user.put("ChemistId",chemistid);
                ...
                documentReference.set(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        if (Paa_name.isEmpty()) {
                            Toast.makeText(AddPatiantSymtom.this, "Please enter a name", Toast.LENGTH_LONG).show();
                            return;
                        }

                        if (!Paa_name.equals(getSinchServiceInterface().getUserName())) {
                            getSinchServiceInterface().stopClient();
                        }

                        if (!getSinchServiceInterface().isStarted()) {
                            getSinchServiceInterface().startClient(Paa_name);
                            showSpinner();
                        } else {
                        ...
                        image.putString("pimageid", "+91"+Paa_num);
                        image.putString("pnamefull", Paa_name);
                        image.commit();

                        //sending emails
                        sendEmails(Paa_name,Paa_num,symtoms,Paa_age);

                        //sending sms to all present in ls
                        sendSMS(Paa_name,Paa_num);
                        ...
                        if (registration_ids.length() > 0) {
                            ...
                            try {
                                ...
                                notificationObject.put("body", "Patient Name is "+Paa_name);
                                ...
                                client.post(getApplicationContext(), url, entity, RequestParams.APPLICATION_JSON, new TextHttpResponseHandler() {
                                    ...
                                    public void onFailure(int statusCode, cz.msebera.android.httpclient.Header[] headers, String responseString, Throwable throwable) {
                                        ...
                                        Toast.makeText(AddPatiantSymtom.this, "failed Notification", Toast.LENGTH_SHORT).show();
                                    }

                                    @Override
                                    public void onSuccess(int statusCode, cz.msebera.android.httpclient.Header[] headers, String responseString) {
                                        Log.i(TAG, responseString);
                                        Toast.makeText(AddPatiantSymtom.this, "Send Notification", Toast.LENGTH_SHORT).show();
                                    }
                                });
                ...
                user2.put("PatientPhone","+91"+Paa_num);
                user2.put("ItemId",id);
                user2.put("PName",Paa_name);
                user2.put("PatientCard",card);
                user2.put("Symtoms",symtoms);
                user2.put("Age",Paa_age);
                user2.put("Gender",Paa_gender);
               /* user.put("ChemistId",ChemistId);
                user.put("ChemistName",ChemistName);
                user.put("ChemistPhoneNumber",ChemistPhoneNumber);*/
                user2.put("DoctorId","");
                ...
                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                    ...
                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                        ...
                        for ( DocumentSnapshot documents : snapshots){
                            ...
                            }else Toast.makeText(AddPatiantSymtom.this, "Email is NULL", Toast.LENGTH_SHORT).show();
                        }
                        /*for(int i=0;i<7;i++){
    ...
    private void uploadImages() {
        Toast.makeText(this, "bahar", Toast.LENGTH_SHORT).show();
                ...
                storageReference.child("userData/").child(imagesList.get(i).getImageName()).putFile(imagesList.get(i).getImageURI()).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        if (task.isSuccessful()){
                            storageReference.child("userData/").child(imagesList.get(finalI).getImageName()).getDownloadUrl().addOnCompleteListener(new OnCompleteListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    ...
                                    if (task.isSuccessful()){
                                        ...
                                        Toast.makeText(AddPatiantSymtom.this, "Couldn't save "+imagesList.get(finalI).getImageName(), Toast.LENGTH_SHORT).show();
                                    }
                            ...
                            progressDialog.setMessage("Uploaded "+counter+"/"+imagesList.size());
                            counter++;
                            Toast.makeText(AddPatiantSymtom.this, "Couldn't upload "+imagesList.get(finalI).getImageName(), Toast.LENGTH_SHORT).show();
                    ...
                    Intent sendStuff = new Intent(AddPatiantSymtom.this, NewDoctorWillCallOffiline.class);
    ...
    private void saveImageDataToFirestore(final ProgressDialog progressDialog) {
        progressDialog.setMessage("uploaded images...");

        for (int i = 0; i < savedImagesUri.size(); i++) {
            reference.update("pre" + i, savedImagesUri.get(i)).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void aVoid) {
