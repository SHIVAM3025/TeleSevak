...
public class UploadImageFromPatient extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadimagefromp);

        Bundle bundle = getIntent().getExtras();
        Conid = bundle.getString("ConsultId");
        DocuP = bundle.getString("Docuphone");


        pd = new ProgressDialog(UploadImageFromPatient.this);
        ...
        id = objectFirebaseFirestore.collection("Consultation").document().getId();
    ...
    public void uploadImage(View view) {
        ...
        try {
            if (imageLocationPath != null) {
                id = objectFirebaseFirestore.collection("Consultation").document().getId() + "." + getExtension(imageLocationPath);
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()) {
                           /* Map<String, String> objectMap = new HashMap<>();
                            ...
                            objectFirebaseFirestore.collection("Consultation").document(Conid)
                                    .update("urlupatient",task.getResult().toString())
...
*/                                        }
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    Toast.makeText(UploadImageFromPatient.this, "Image not upload" + e.getMessage(), Toast.LENGTH_LONG).show();
                                    pd.dismiss();
                                }
                            });
                            ...
                            objectFirebaseFirestore.collection("Consultation").document(Conid)
                                    .update("urlupatientdesc",uploadPicET.getText().toString())
                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                        @Override
                                        public void onSuccess(Void aVoid) {
                                            Toast.makeText(UploadImageFromPatient.this, "image and text is uploaded", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(UploadImageFromPatient.this, task.getException().toString(), Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
